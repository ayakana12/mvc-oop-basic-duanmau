...
define('BASE_URL_LAYOUT_BANNER', BASE_URL.'views/layout/img/'); // Đường dẫn đến ảnh banner trong layout
...
define('PATH_ASSETS_UPLOADS', PATH_ROOT . 'uploads/'); // Đường dẫn vật lý đến thư mục chứa ảnh sản phẩm
